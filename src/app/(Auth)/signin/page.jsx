      ...
      <div className="mt-8 w-full max-w-md rounded-3xl border border-base-200 bg-base-100 p-7 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-2 rounded-2xl bg-primary px-6 py-3.5 font-semibold text-white shadow-md transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg disabled:opacity-60 disabled:hover:translate-y-0"
          >
